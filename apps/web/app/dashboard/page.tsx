...
import { Award, BookOpen, Calendar, ChevronRight, Crown, Gamepad2, LineChart, Rocket, Star, Trophy } from "lucide-react"
          ...
          <section className="flex flex-col md:flex-row gap-6 items-stretch">
            <Card className="w-full md:w-2/3 card-container h-full flex flex-col">
              <CardHeader className="pb-2">
                <div className="flex justify-between items-center">
                  <CardTitle className="text-xl text-dark-gray">Welcome back, Jamie!</CardTitle>
                  <Badge className="bg-success/20 text-success border-0 flex items-center gap-1 px-3 py-1">
                    <Calendar className="h-3 w-3" />
                    Day 12 Streak
                  </Badge>
                </div>
                <CardDescription className="text-neutral-gray">Continue your math adventure</CardDescription>
              </CardHeader>
              <CardContent className="flex-1">
                <div className="space-y-6 h-full flex flex-col">
                  <div>
                    <div className="flex justify-between mb-2">
                      <span className="text-sm font-medium">Level 5: Fractions Master</span>
                      <span className="text-sm font-medium font-space-mono">65%</span>
                    </div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-auto">
                    <div className="stat-box">
                      ...
                      <span className="text-xs text-neutral-gray">Lessons Completed</span>
                    </div>
                    <div className="stat-box">
                      <Trophy className="h-8 w-8 text-secondary mb-2" />
                      <span className="text-sm font-medium font-mono">8</span>
                      <span className="text-xs text-neutral-gray">Badges Earned</span>
                    </div>
                    <div className="stat-box">
                      <Gamepad2 className="h-8 w-8 text-primary mb-2" />
                      <span className="text-sm font-medium font-mono">24</span>
                      <span className="text-xs text-neutral-gray">Games Played</span>
                    </div>
                    <div className="stat-box">
                      <LineChart className="h-8 w-8 text-success mb-2" />
                      <span className="text-sm font-medium font-mono">85%</span>
                      <span className="text-xs text-neutral-gray">Accuracy</span>
                    </div>
                  </div>
                </div>
              </CardContent>
              <CardFooter>
                <Button className="w-full bg-primary text-white hover:bg-primary/90">Continue Learning</Button>
              </CardFooter>
            </Card>
            ...
            <Card className="w-full md:w-1/3 card-highlight h-full flex flex-col">
              <CardHeader>
                ...
                <CardDescription className="text-neutral-gray">Complete to earn extra stars!</CardDescription>
              </CardHeader>
              <CardContent className="flex-1">
                <div className="space-y-4 h-full flex flex-col">
                  <div className="flex items-center gap-3 p-3 rounded-lg bg-success/10 border border-success/20">
                    ...
                    <div className="flex-1">
                      <h4 className="text-sm font-semibold">Solve 5 Fraction Problems</h4>
                      <p className="text-xs text-neutral-gray">3/5 completed</p>
                    </div>
                    <Button variant="ghost" size="icon" className="rounded-full hover:bg-success/10">
                  ...
                  <div className="flex items-center gap-3 p-3 rounded-lg bg-white border border-gray-200">
                    ...
                    <div className="flex-1">
                      <h4 className="text-sm font-semibold">Complete Geometry Quiz</h4>
                  ...
                  <div className="flex items-center gap-3 p-3 rounded-lg bg-white border border-gray-200">
                    ...
                    <div className="flex-1">
                      <h4 className="text-sm font-semibold">Win Math Battle Game</h4>
                      <p className="text-xs text-neutral-gray">Earn 100 stars</p>
                    </div>
            ...
            <TabsContent value="recommended" className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Card className="card-container h-full">
                  <div className="card-content-wrapper h-full">
                    <CardHeader className="card-header-fixed">
                      <CardTitle className="text-base">Fraction Operations</CardTitle>
                      <CardDescription className="text-neutral-gray">Interactive lesson</CardDescription>
                    </CardHeader>
                    <CardContent className="card-content-fixed">
                      ...
                      <div className="card-meta">
                        ...
                        <div className="flex items-center">
                          ...
                          <span className="text-sm font-space-mono">25 stars</span>
                        </div>
                      </div>
                    </CardContent>
                    <CardFooter className="card-footer-fixed">
                      <Button className="w-full bg-primary text-white hover:bg-primary/90">Start Lesson</Button>
                    </CardFooter>
                  </div>
                </Card>
                <Card className="card-container h-full">
                  <div className="card-content-wrapper h-full">
                    <CardHeader className="card-header-fixed">
                      <CardTitle className="text-base">Fraction Frenzy</CardTitle>
                      <CardDescription className="text-neutral-gray">Math game</CardDescription>
                    </CardHeader>
                    <CardContent className="card-content-fixed">
                      <div className="flex-1 flex items-center justify-center">
                      ...
                      <div className="card-meta">
                        ...
                        <div className="flex items-center">
                          <Star className="h-4 w-4 text-secondary fill-secondary mr-1" />
                          <span className="text-sm font-space-mono">40 stars</span>
                        </div>
                      </div>
                    </CardContent>
                    <CardFooter className="card-footer-fixed">
                      <Link href="/games/fraction-frenzy" className="w-full">
                        <Button className="w-full bg-primary text-white hover:bg-primary/90">Play Game</Button>
                      </Link>
                    </CardFooter>
                  </div>
                </Card>
                <Card className="card-container h-full">
                  <div className="card-content-wrapper h-full">
                    <CardHeader className="card-header-fixed">
                      <CardTitle className="text-base">Fraction Challenge</CardTitle>
                      <CardDescription className="text-neutral-gray">Weekly competition</CardDescription>
                    </CardHeader>
                    <CardContent className="card-content-fixed">
                      <div className="flex-1 flex items-center justify-center">
                      ...
                      <div className="card-meta">
                        ...
                        <div className="flex items-center">
                          <Star className="h-4 w-4 text-secondary fill-secondary mr-1" />
                          <span className="text-sm font-space-mono">100 stars</span>
                        </div>
                      </div>
                    </CardContent>
                    <CardFooter className="card-footer-fixed">
            ...
            <TabsContent value="popular" className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Card className="card-container h-full">
                  <div className="card-content-wrapper h-full">
                    <CardHeader className="card-header-fixed">
                      <CardTitle className="text-base">Math Battle Royale</CardTitle>
                      <CardDescription className="text-neutral-gray">Multiplayer game</CardDescription>
                    </CardHeader>
                    <CardContent className="card-content-fixed">
                      <div className="flex-1 flex items-center justify-center">
                      ...
                      <div className="card-meta">
                        ...
                        <div className="flex items-center">
                          <Star className="h-4 w-4 text-secondary fill-secondary mr-1" />
                          <span className="text-sm font-space-mono">75 stars</span>
                        </div>
                      </div>
                    </CardContent>
                    <CardFooter className="card-footer-fixed">
            ...
            <TabsContent value="recent" className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Card className="card-container h-full">
                  <div className="card-content-wrapper h-full">
                    <CardHeader className="card-header-fixed">
                      <CardTitle className="text-base">Geometry Basics</CardTitle>
                      <CardDescription className="text-neutral-gray">Interactive lesson</CardDescription>
                    </CardHeader>
                    <CardContent className="card-content-fixed">
                      <div className="flex-1 flex items-center justify-center">
                      ...
                      <div className="card-meta">
                        ...
                        <div className="flex items-center">
                          <Star className="h-4 w-4 text-secondary fill-secondary mr-1" />
                          <span className="text-sm font-space-mono">20 stars</span>
                        </div>
                      </div>
                    </CardContent>
                    <CardFooter className="card-footer-fixed">
                      <Button className="w-full bg-primary text-white hover:bg-primary/90">Resume Lesson</Button>
                    </CardFooter>
                  </div>
                </Card>
