      ...
      <div className="container px-4 mx-auto">
        <div className="bg-white rounded-3xl p-8 md:p-12 relative overflow-hidden shadow-xl border border-gray-100">
          ...
          <div className="relative z-10 max-w-3xl">
            <Badge className="mb-6 bg-primary/10 text-primary border-0 py-1.5 px-3">Get started today</Badge>
            <h2 className="text-3xl md:text-4xl font-bold text-dark-gray mb-4">Ready to Transform Math Learning?</h2>
            <p className="text-lg text-neutral-gray mb-8">
              Join MathQuest today and discover a world where math is fun, engaging, and rewarding. Our interactive
              platform makes learning an adventure that students actually look forward to!
            </p>
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-6">
              {["No Credit Card Required", "14-Day Free Trial", "Cancel Anytime", "Full Access to All Features"].map(
                (feature, index) => (
