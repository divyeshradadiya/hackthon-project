  ...
  return (
    <section className="relative pt-20 pb-16 md:pt-24 md:pb-20 lg:pt-28 lg:pb-28 overflow-hidden bg-gradient-to-br from-white via-primary/5 to-secondary/10">
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="w-full lg:max-w-3xl xl:max-w-4xl text-center mx-auto">
            ...
            <p className="text-lg md:text-xl text-neutral-gray mb-8 max-w-lg mx-auto">
              Personalized lessons, real-time quizzes, and interactive
              challenges—powered by AI to match your pace and style.
            </p>
            ...
            <div className="flex items-center justify-center mt-8 gap-4">
              ...
              <div className="text-neutral-gray">
                <span className="font-bold text-dark-gray">10,000+</span>{" "}
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute top-1/4 left-[10%] transform -translate-x-1/2 animate-float-slow"
        ...
        <div
          className="absolute bottom-1/4 left-[15%] transform -translate-x-1/2 animate-float-slow"
        ...
        <div
          className="absolute top-1/3 right-[10%] transform translate-x-1/2 animate-float-slow"
        ...
        <div
          className="absolute bottom-1/3 right-[15%] transform translate-x-1/2 animate-float-slow"
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none z-decoration">
        ...
        <div className="absolute top-1/3 left-1/4 text-6xl font-bold text-primary/5 animate-float-slow">
          +
        </div>
        <div
