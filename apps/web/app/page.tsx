      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 bg-blue-300 lg:px-8 py-12">
        ...
        <div className="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
          ...
          >
            ...
            <p className="mt-4 text-gray-600">Upload your document to start the learning journey</p>
          </a>
          ...
          >
            ...
            <p className="mt-4 text-gray-600">Test your knowledge with AI-generated quizzes</p>
          </a>
          ...
          >
            ...
            <p className="mt-4 text-gray-600">Follow your personalized learning journey</p>
          </a>
        </div>
